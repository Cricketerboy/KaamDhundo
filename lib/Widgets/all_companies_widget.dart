...
class _AllWorkersWidgetState extends State<AllWorkersWidget> {
  ...
  Widget build(BuildContext context) {
    return Card(
      elevation: 8,
      color: Color.fromARGB(255, 223, 202, 202),
          ...
          child: CircleAvatar(
            ...
            child: Image.network(
              widget.userImageUrl == null
                  ? 'https://static.vecteezy.com/system/resources/previews/014/554/760/original/man-profile-negative-photo-anonymous-silhouette-human-head-businessman-worker-support-illustration-vector.jpg0 '
                  : widget.userImageUrl,
            ),
          ),
        ),
